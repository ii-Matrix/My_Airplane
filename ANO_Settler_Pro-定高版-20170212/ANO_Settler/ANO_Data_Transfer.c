...
/////////////////////////////////////////////////////////////////////////////////////
	...
	{
		f.send_status = 0;
		ANO_DT_Send_Status(imu_data.rol,imu_data.pit,imu_data.yaw,baro_height,0,fly_ready);	
	}	
/////////////////////////////////////////////////////////////////////////////////////
...
/////////////////////////////////////////////////////////////////////////////////////
	...
	{
		f.send_senser2 = 0;
		ANO_DT_Send_Senser2(baro_height,0);
	}	
/////////////////////////////////////////////////////////////////////////////////////
...
void ANO_DT_Send_User()
{
	...
	_temp = (s16)(baro_height);//ctrl_1.exp_rol;           //1
	data_to_send[_cnt++]=BYTE1(_temp);
	data_to_send[_cnt++]=BYTE0(_temp);

	_temp = (s16)(baro_speed);//ctrl_1.fb_rol;            //2
	data_to_send[_cnt++]=BYTE1(_temp);
	data_to_send[_cnt++]=BYTE0(_temp);	
	
	_temp = (s16)(baro_fus.speed);//val_1_rol.err_i;          //3
	data_to_send[_cnt++]=BYTE1(_temp);
	data_to_send[_cnt++]=BYTE0(_temp);	

	_temp = (s16)(baro_fus.speed_fix);//ctrl_1.out_rol;          //4
	data_to_send[_cnt++]=BYTE1(_temp);
	data_to_send[_cnt++]=BYTE0(_temp);	
	
	_temp = (s16)(baro_fus.height);//ctrl_1.out_rol;          //5
	data_to_send[_cnt++]=BYTE1(_temp);
	data_to_send[_cnt++]=BYTE0(_temp);		
